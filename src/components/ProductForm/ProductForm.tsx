...
// import CodeConfirmModal from '../CodeConfirmModal/CodeConfirmModal';
...
// }: ProductFormProps & { products: ProductForm[] }) {
...
//     const [pendingData, setPendingData] = useState<ProductForm | null>(null);
...
//         if (data.code && products.some(p => p.code === data.code)) {
//             setPendingData(data);
//             setShowModal(true);
//         } else {
//             confirmAdd(data);
...
//     const confirmAdd = (data: ProductForm) => {
//         onAdd({ 
//             ...data, 
...
//         <CodeConfirmModal
//             show={showModal}
//             message={`El código "${pendingData?.code}" ya existe. ¿Desea continuar?`}
//             onConfirm={() => pendingData && confirmAdd(pendingData)}
//             onCancel={cancelAdd}
//         />
//         </>
//     );
...
interface ProductFormComponentProps extends ProductFormProps {
    products?: ProductForm[]; // opcional y seguro
}

function ProductFormComponent({
    onAdd,
    products = [], // valor por defecto vacío
    persistUsePercentage,
    persistPercentage,
    setPersistUsePercentage,
    setPersistPercentage
