...
export type GeneralInfo = { lugar: string; fecha: string; receptor: string; otros?: string };
export type ProducerInfo = { nombre: string; apellido: string; documento?: string; telefono?: string; email?: string };
export type Product = { id: string; code?: string; detail: string; amount: number; cost_price: number; sale_price: number };
